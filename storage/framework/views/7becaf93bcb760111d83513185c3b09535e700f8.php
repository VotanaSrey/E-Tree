        ...
        <form action="<?php echo e(route('message')); ?>" method="POST">
          ...
          <div class="control-group form-group">
            <div class="controls">
              ...
              <?php echo $errors->first('message', '<small class="text-danger">:message</small>'); ?>
...
<?php echo $__env->make('Container.HeaderAndFooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Tree/resources/views/application/contact.blade.php ENDPATH**/ ?>