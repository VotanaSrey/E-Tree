        ...
        <div class="bg-white shadow p-5">
            ...
            <form class="pb-3" action="<?php echo e(route('update-dob')); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" value="<?php echo e(old('dob')); ?>" name="dob" id="dob" class="form-control" placeholder="Enter new date of birth">
...
<?php echo $__env->make('Container.HeaderAndFooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Tree/resources/views/setting/change-dob.blade.php ENDPATH**/ ?>